<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebApplication1.LoginView" %>
...
<br />
        ...
        <asp:TextBox ID="TextBox1" runat="server" style="margin-left: 36px" Width="227px"></asp:TextBox>
<br />


        <p>
            <asp:Button ID="buttonSend" runat="server" style="margin-left: 108px" Text="Versturen" Width="76px" />
        </p>
    </form>
